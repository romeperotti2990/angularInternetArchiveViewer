...
It should be designed to search internet archive and use the files it finds without the user having to download them. 
...
Currently this is an empty angular project with 2 empty components in /src/app/components.
